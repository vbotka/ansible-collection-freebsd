...
ansible-playbook pb.yml -t poudriere_debug -e poudriere_debug=true | tee out/out-01.txt
ansible-playbook pb.yml -t poudriere_pkg -e poudriere_install=true | tee out/out-02.txt
ansible-playbook pb.yml -t poudriere_dirs | tee out/out-03.txt
ansible-playbook pb.yml -t poudriere_key | tee out/out-04.txt
ansible-playbook pb.yml -t poudriere_cert -e poudriere_cert=true | tee out/out-05.txt
ansible-playbook pb.yml -t poudriere_conf | tee out/out-06.txt
ansible-playbook pb.yml -t poudriere_pkglists | tee out/out-07.txt
...
#
ansible-playbook pb-postinstall.yml -t fp_packages -e fp_install=true | tee out/out-16.txt
ansible-playbook pb-postinstall.yml -t fp_qemu | tee out/out-17.txt
#
