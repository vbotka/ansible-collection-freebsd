...
ansible-playbook vbotka.freebsd.pb_iocage_ansible_clients.yml -i iocage.ini -l iocage_02 -t swarm -e swarm=true | tee out/out-11.txt

VBOTKA_FREEBSD_BATCH=true ansible-playbook vbotka.freebsd.pb_iocage_update_repos.yml -i iocage.ini -l iocage_02 | tee out/out-12.txt
