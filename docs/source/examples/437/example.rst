...
437 Role vbotka.freebsd.haproxy (swarm)
---------------------------------------
...
.. index:: single: swarms destroy; Example 437
...
.. index:: single: vbotka.freebsd.haproxy; Example 437
...
.. code-block:: console
   ...
   (env) > ansible-playbook -i iocage.ini \
                            ...
                            -e iocage_jails_source=inventory \
