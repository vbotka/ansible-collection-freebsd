...
(cd ../202 && ansible-playbook vbotka.freebsd.pb_iocage_ansible_clients.yml -t clone -e clone=true -i iocage.ini)
...
# display sshd rcvar
ansible-playbook pb-test-01.yml -i hosts --flush-cache| tee out/out-03.txt
...
# start apcupsd
ansible-playbook pb-test-07.yml -i iocage.ini -e debug=true | tee out/out-09.txt

# module vbotka.freebsd.service examples
# ansible-playbook pb-examples.yml -i iocage.ini -i hosts
