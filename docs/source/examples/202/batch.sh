...
ansible-playbook vbotka.freebsd.pb_iocage_template.yml -i iocage-hosts.ini -l iocage_01,iocage_02 | tee out/out-01.txt
...
ansible-playbook vbotka.freebsd.pb_iocage_ansible_clients.yml -i iocage-hosts.ini -l iocage_01,iocage_02 -t clone -e clone=true | tee out/out-04.txt
