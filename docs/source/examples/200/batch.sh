...
ansible-playbook vbotka.freebsd.pb_iocage_ansible_clients.yml -i iocage-hosts.ini -t clone -e clone=true | tee out/out-04.txt
ansible-playbook vbotka.freebsd.pb_iocage_ansible_clients.yml -i iocage-hosts.ini -t list -e debug=true | tee out/out-09.txt
