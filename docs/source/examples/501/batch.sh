...
ansible-playbook pb-packages.yml -i iocage.ini | tee out/out-02.txt
ansible-playbook pb-loader.yml -i iocage.ini | tee out/out-03.txt
ansible-playbook pb-network.yml -i iocage.ini | tee out/out-04.txt
