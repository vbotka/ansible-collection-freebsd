...
The ``iocage`` property ``notes`` is used to store ``iocage tags``. As described
in `man iocage`_:
...
When the playbook :ref:`ug_pb-iocage-ansible-clients` provisions jails on host
``iocage_02``:
...
.. code-block:: console
   ...
   +=====+==========+======+=======+======+=================+====================+=====+================+==========+
   | 149 | afa9e515 | off  | up    | jail | 14.1-RELEASE-p6 | epair0b|10.1.0.122 | -   | ansible-client | no       |
   +-----+----------+------+-------+------+-----------------+--------------------+-----+----------------+----------+
   | 148 | c1670497 | off  | up    | jail | 14.1-RELEASE-p6 | epair0b|10.1.0.135 | -   | ansible-client | no       |
   +-----+----------+------+-------+------+-----------------+--------------------+-----+----------------+----------+
   | 147 | test_111 | off  | up    | jail | 14.1-RELEASE-p6 | em0|10.1.0.111/24  | -   | ansible-client | no       |
   +-----+----------+------+-------+------+-----------------+--------------------+-----+----------------+----------+
...
.. important::
   ...
   The playbook :ref:`ug_pb-iocage-ansible-clients` creates the iocage tag
