...
Quoting `Inventory aliases`_: ::
  ...
  The inventory_hostname is the unique identifier for a host in Ansible, this can be an IP or a
...
Set *notes*. The tag *alias* is used to create inventory aliases
