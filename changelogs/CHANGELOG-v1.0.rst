...
--------------
Docs. UG update.
Docs. Links collected in docs/source/links.rst
Docs. Add link 'collection vbotka.freebsd'.
Docs. Replaced links to Ansible Galaxy.
...
Release Summary
---------------
Add filter project. Upgrade roles. Update docs.
